              ...
              <tbody>
                {vacations.map((vacation) => (
                  <tr key={vacation.vacation_id}>
                    <td>
                      <img 
                        src={`http://localhost:5001/images/${vacation.picture_file_name}`}
                    ...
                    <td className="likes-cell">
                      <div className="likes-display-admin">
                        <div className="likes-icon-admin">
                          <svg viewBox="0 0 24 21">
                            <path d="M12 21C12 21 2.5 13.5 2.5 7.5C2.5 5.5 4 4 6 4C8 4 10 5 12 7C14 5 16 4 18 4C20 4 21.5 5.5 21.5 7.5C21.5 13.5 12 21 12 21Z" />
                          </svg>
                        </div>
                        <span className="likes-count-admin">{vacation.likes_count || 0}</span>
                      </div>
                    </td>
