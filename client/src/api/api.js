...
// Using vite-backend on port 5001
...
export const statsAPI = {
  getVacationsStats: () => apiRequest('/vacations/stats'),
  getUsersCount: () => apiRequest('/users/count'),
  getLikesCount: () => apiRequest('/likes/count'),
  getLikesDistribution: () => apiRequest('/likes/distribution')
};
